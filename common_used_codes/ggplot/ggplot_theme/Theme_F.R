...
theme_F <- theme_bw()+
  theme(plot.title = element_text(size = 20, face="bold", hjust = 0.5), 
        axis.title.x = element_text(size = 15, color = "black", face = "bold", vjust = 0.5, hjust = 0.5, angle = 1),
        axis.text.x = element_text(size = 15, color = "black", face = "bold", vjust = 0.5, hjust = 0.5, angle = 450),
