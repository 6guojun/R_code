...
###usage: MakCorPlot <- function(DataCor, Tnam = Tnam, height = 512, width = 512, cex.axis = 2, ...)
...
MakCorPlot <- function(DataCor, Tnam = Tnam, height = 10, width = 10, cex.axis = 2, ...){
  ...
  pdf(file = paste(Tnam,  ".pdf", sep = ""), height, width)
