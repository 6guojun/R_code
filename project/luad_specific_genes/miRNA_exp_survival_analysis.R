...
mak_boxplot <- function(data_unit, gnam){
  ...
  p = ggplot(data = data_unit, aes(data_unit[, 1], data_unit[, 2])) +
    ...
    theme(plot.title = element_text(size=25, face="bold", hjust = 0.5), 
          axis.title.x = element_text(size = 25, color = "black", face = "bold", vjust = 0.5, hjust = 0.5, angle = 1),
          axis.text.x = element_text(size = 25, color = "black", face = "bold", vjust = 0.5, hjust = 0.5, angle = 450),
          axis.title.y = element_text(size = 25, color = "black", face = "bold", vjust = 0.5, hjust = 0.5, angle = 450),
